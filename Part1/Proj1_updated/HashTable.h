...
public:
	...
	list<MyVector*> range_search_eucledian(MyVector*,double,int,int);
	double NN_search_cosine(MyVector*,int,int);
	list<MyVector*> range_search_cosine(MyVector*,double,int,int);
...
public:
	...
	list<MyVector*> range_search_cosine(MyVector*,double);
	double NN_search_eucledian(MyVector*);
	list<MyVector*> range_search_eucledian(MyVector*, double);
